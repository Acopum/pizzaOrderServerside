...
if($_SERVER["REQUEST_METHOD"] == "POST" && $_POST["subUsed"]==1){
    ...
    $updateQuery = "UPDATE pizza_orders SET cost=$cost, time='$date', customer_name='$customer', address='$address' WHERE order_number = $idno";
...
$selectQuery = "SELECT * FROM pizza_orders WHERE order_number = $idno";
